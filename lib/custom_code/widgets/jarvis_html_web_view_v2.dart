...
class _JarvisHtmlWebViewV2State extends State<JarvisHtmlWebViewV2>
  ...
  bool _permissionError = false; // плагин не сработал
...
`;
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => _checkPermissionAlreadyGranted());
  }
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.resumed && !_showWebView) {
      _checkPermissionAlreadyGranted();
    }
  }

  Future<void> _checkPermissionAlreadyGranted() async {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    _permissionError
                        ? 'Не удалось запросить доступ к микрофону. Включите микрофон в настройках приложения или попробуйте снова.'
                        : _permissionDenied
                            ? 'Доступ к микрофону запрещён. Включите его в настройках приложения для работы голосового ассистента.'
                  ...
                  if (!_permissionDenied && !_permissionError)
                    ElevatedButton.icon(
