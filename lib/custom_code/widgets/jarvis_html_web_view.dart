...
class JarvisHtmlWebView extends StatefulWidget {
  const JarvisHtmlWebView({
    Key? key,
    this.width,
    this.height,
  }) : super(key: key);
  ...
  @override
  State<JarvisHtmlWebView> createState() => _JarvisHtmlWebViewState();
}

class _JarvisHtmlWebViewState extends State<JarvisHtmlWebView> {
